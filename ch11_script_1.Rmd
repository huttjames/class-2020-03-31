...
ggplot(county, aes(poverty, less_than_hs)) + geom_point() + theme_classic()

county %>% 
  summarise(mean_pov = mean(poverty), 
            mean_less_than_HS = mean(less_than_hs))

filter(county, name == "Middlesex County", state == "MA")
...
county %>%
  summarise(correlation = cor(poverty, less_than_hs))
...
ggplot(county, aes(poverty, less_than_hs)) + 
  geom_point() + 
  theme_classic() + 
...
ggplot(county, aes(poverty, less_than_hs, color = region)) + 
  geom_point() + 
  theme_classic() + 
